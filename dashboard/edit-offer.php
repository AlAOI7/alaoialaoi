...
$selected_stmt = mysqli_prepare($conn, $selected_sql);
mysqli_stmt_bind_param($selected_stmt, "i", $offer['id']);
            ...
            <div class="row">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      rows="4" 
                                      required
                                      placeholder="أدخل وصف مفصل للعرض"><?php echo htmlspecialchars($offer['description']); ?></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="button_text" 
                                       name="button_text" 
                                       value="<?php echo htmlspecialchars($offer['button_text']); ?>" 
                                       placeholder="نص الزر">
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" 
                                   ...
                                   id="link" 
                                   name="link" 
                                   value="<?php echo htmlspecialchars($offer['link']); ?>" 
                    ...
                    <div class="form-section bg-light">
                        ...
                        <a href="delete-offer.php?id=<?php echo $offer['id']; ?>" 
                           class="btn btn-outline-danger btn-lg w-100 mt-3 py-3"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            <?php foreach ($selected_products as $product_id): ?>
                ...
                if ($product_info): ?>
                    $('.product-checkbox[data-product-id="<?php echo $product_id; ?>"] input').prop('checked', true);
                <?php endif; ?>
            <?php endforeach; ?>
        });
